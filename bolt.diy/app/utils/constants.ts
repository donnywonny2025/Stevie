...
// Set Google/Gemini as the default provider (confirmed working with unlimited quota)
export const DEFAULT_PROVIDER = llmManager.getProvider('Google') || llmManager.getDefaultProvider();
